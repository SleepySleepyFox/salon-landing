...
export default function About() {
  return (
    <div className="container md:flex md:justify-between p-2" id="About">
      <div className="grid grid-cols-12 grid-rows-1 p-6 w-full">
        ...
        <img
          src={about_2}
          alt=""
          className="col-start-6 col-end-12 row-start-1 border-8 border-white"
        />
        <img
          src={about_3}
          alt=""
          className="col-start-3 col-end-10 row-end-2 mt-44 border-8 border-white"
        />
      </div>

      <div className="p-2 flex flex-col items-center justify-center md:items-start">
        <h3 className="text-secondary font mt-2 text-center md:text-left">
          About Us
        </h3>
        <h1 className="text-black font-black md:text-4xl text-center md:text-left">

  ...
  return (
    <div className='h-full md:flex md:p-6 md:justify-center'>
        <div className='text-center md:text-left md:w-[45%] md:self-center'>
            ...
            <h1 className='font-black md:text-4xl'>What Our Clients Say About Us</h1>
            <p className='text-paragraph'>Let your hairdressers do their amazing job. Trim the hair to get your desired look. Book appointment with us for your favorite hair Styles!</p>

    ...
    <div className="h-full md:flex md:flex-col mt-10">
      <div className="md:flex self-center">
        ...
        <div className="p-6 flex flex-col gap-4 md:bg-secondary md:w-96 md:text-left">
          <h1 className="font-black text-center md:text-white md:text-left">
            WORKING DAYS
          </h1>
          ...
          <button className="bg-secondary text-black h-12 md:self-start md:border-black md:border-[0.8px] md:px-10">
            Book Now
          </button>
        </div>
      </div>
